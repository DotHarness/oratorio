...
Oratorio 是看板，[DotCraft](https://www.dotcraft.net/) 是干活的 AI Agent。两者是相互独立的应用，各负责一半 —— Oratorio 让你看清工作的进展，DotCraft 负责思考、调用工具、产出结果。
...
- [DotCraft 快速开始 ↗](https://www.dotcraft.net/zh/getting-started) —— 安装、模型配置、第一次会话
- [DotCraft 项目级工作区 ↗](https://www.dotcraft.net/zh/features/workspace) —— 跟随项目的数据有哪些、配置如何叠加
- [DotCraft 配置参考 ↗](https://www.dotcraft.net/zh/developing/configuration) —— 完整字段表
