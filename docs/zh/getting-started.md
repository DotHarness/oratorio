...
Oratorio 是一张看板，让你把工作交给 AI Agent，并跟进它的进展。真正干活的 Agent 来自 [DotCraft](https://dotharness.github.io/dotcraft/) —— 一个住在你项目里的 AI，它记得每次对话、学会项目专属的 Skill 与插件、通过 MCP 连接你的本地工具，并接到你选定的模型。
...
安装 [DotCraft](https://dotharness.github.io/dotcraft/)，在 DotCraft 中打开你的项目，完成首次设置 —— 选定模型，发一条测试对话，比如"读一下这个项目的 README，告诉我它是做什么的"。这一步走完，你的项目里就住着一个可用的 AI Agent。
